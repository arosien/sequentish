...
[cols=".^2a,.^a",frame=none,grid=none]
|===
| While not originally popular with t-shirt collectors in 1934, sequent calculus is still cool. |
image::Nintendo.png[]
|===
[cols="2a,a",frame=none,grid=none]
|===
| Curry-Howard lets us translate our programming problems into logic problems, and back. It's used _everywhere_. And it's not too difficult to implement yourself. |
[graphviz]
....
digraph x {
  // pad=0.4
